...
namespace WpfExplorer.Location.UI.Units
{
    public class LocatorButton : Button
    {
        public static readonly DependencyProperty ActionTypeProperty =
            DependencyProperty.Register("ActionType",
                typeof(ActionType), typeof(LocatorButton), new PropertyMetadata(ActionType.Up));
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(LocatorButton), 
                new FrameworkPropertyMetadata(typeof(LocatorButton)));
        }
    }
}
